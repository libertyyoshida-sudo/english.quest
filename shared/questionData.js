...
const BASIC_WORDS_BY_LANGUAGE = {
  ja:['こんにちは','ありがとう','はい','いいえ','水','食べ物','本','学校','家','友だち','仕事','お金','時間','今日','明日','言語','旅行','市場','助ける','勉強する','家族','朝','夜','都市','国','会社','オフィス','コンピューター','電話','駅','空港','ホテル','レストラン','医者','病院','薬','左','右','良い','悪い'],
  ...
  pt:['olá','obrigado','sim','não','água','comida','livro','escola','casa','amigo','trabalho','dinheiro','tempo','hoje','amanhã','língua','viagem','mercado','ajudar','estudar','família','manhã','noite','cidade','país','empresa','escritório','computador','telefone','estação','aeroporto','hotel','restaurante','médico','hospital','remédio','esquerda','direita','bom','ruim'],
  ...
  ru:['здравствуйте','спасибо','да','нет','вода','еда','книга','школа','дом','друг','работа','деньги','время','сегодня','завтра','язык','путешествие','рынок','помогать','учиться','семья','утро','ночь','город','страна','компания','офис','компьютер','телефон','станция','аэропорт','отель','ресторан','врач','больница','лекарство','лево','право','хороший','плохой'],
  ...
  tr:['merhaba','teşekkürler','evet','hayır','su','yemek','kitap','okul','ev','arkadaş','iş','para','zaman','bugün','yarın','dil','seyahat','pazar','yardım etmek','çalışmak','aile','sabah','gece','şehir','ülke','şirket','ofis','bilgisayar','telefon','istasyon','havaalanı','otel','restoran','doktor','hastane','ilaç','sol','sağ','iyi','kötü'],
  ...
  yue:['你好','多謝','係','唔係','水','食物','書','學校','屋企','朋友','工作','錢','時間','今日','聽日','語言','旅行','市場','幫手','學習','屋企人','朝早','夜晚','城市','國家','公司','辦公室','電腦','電話','車站','機場','酒店','餐廳','醫生','醫院','藥','左','右','好','差'],
  ...
  pl:['cześć','dziękuję','tak','nie','woda','jedzenie','książka','szkoła','dom','przyjaciel','praca','pieniądze','czas','dzisiaj','jutro','język','podróż','rynek','pomagać','uczyć się','rodzina','rano','noc','miasto','kraj','firma','biuro','komputer','telefon','stacja','lotnisko','hotel','restauracja','lekarz','szpital','lekarstwo','lewo','prawo','dobry','zły'],
  nl:['hallo','dank je','ja','nee','water','eten','boek','school','huis','vriend','werk','geld','tijd','vandaag','morgen','taal','reis','markt','helpen','studeren','familie','ochtend','nacht','stad','land','bedrijf','kantoor','computer','telefoon','station','luchthaven','hotel','restaurant','dokter','ziekenhuis','medicijn','links','rechts','goed','slecht'],
  el:['γεια σας','ευχαριστώ','ναι','όχι','νερό','φαγητό','βιβλίο','σχολείο','σπίτι','φίλος','δουλειά','χρήματα','χρόνος','σήμερα','αύριο','γλώσσα','ταξίδι','αγορά','βοηθώ','μελετώ','οικογένεια','πρωί','νύχτα','πόλη','χώρα','εταιρεία','γραφείο','υπολογιστής','τηλέφωνο','σταθμός','αεροδρόμιο','ξενοδοχείο','εστιατόριο','γιατρός','νοσοκομείο','φάρμακο','αριστερά','δεξιά','καλός','κακός'],
